# injection-strategy Specification

## Purpose
TBD - created by archiving change add-injection-strategies. Update Purpose after archive.
## Requirements
...
- **WHEN** a caller uses `Retry<T>` convenience fields
